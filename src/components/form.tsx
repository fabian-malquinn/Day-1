...
export default function Form(){
    ...
    return (
        <div className="bg-white px-10 py-10 rounded-xl border-2 border-gray-100 shadow-3xl">
            ...
            <div>
                ...
                <div className="mt-8 flex flex-col gap-y-4">
                    <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-violet-500 text-white text-lg font-bold" onClick={handleClick}>Sign in</button>
